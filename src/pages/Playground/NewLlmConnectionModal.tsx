import React, { useState } from "react";
 ...
 const NewLlmConnectionModal: React.FC<NewLlmConnectionModalProps> = ({
  ...
  const newHeaders = [...extraHeaders];
  newHeaders.splice(index, 1, value);
  setExtraHeaders(newHeaders);
  };
  ...
  <p>
  Optional additional HTTP headers to include with requests towards LLM
  provider. All header values stored encrypted on our servers.
  </p>
